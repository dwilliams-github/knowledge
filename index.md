...
All research entries, sorted by topic.

<!-- Add entries below as: - [Title](topics/topic/entry.md) — one-line summary -->

## Generative Models

- [Stochastic Interpolants](topics/generative-models/stochastic-interpolants.md) — Albergo & Vanden-Eijnden (2022/2023); unifying framework for flows and diffusions via $I_t = \alpha_t I_0 + \beta_t I_1$
